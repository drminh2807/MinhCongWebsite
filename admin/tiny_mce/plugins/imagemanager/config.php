<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../upload/sanpham/hinhchinh/'; // absolute or relative from this script path, required.
	...
	// Authenication
	//$mcImageManagerConfig['authenticator'] = "SessionAuthenticator";// phai login - khoaphp
