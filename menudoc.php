...
<script type="text/javascript" src="menudoc/ddaccordion.js">
...
.arrowsidemenu div a{ /*header bar links*/
	...
	display: block;
	background: transparent url(menudoc/arrowgreen.gif) 100% 0;
...
<div class="menuheaders"><a href="#" title="Forums">Forums</a></div>
<ul class="menucontents">
	<li><a href="#">Horizontal CSS Menus</a></li>
	<li><a href="#">Vertical CSS Menus</a></li>
	<li><a href="#">Image CSS</a></li>
...
<div class="menuheaders"><a href="#" title="Tools">Webmaster Tools</a></div>
<ul class="menucontents">
	<li><a href="#">Horizontal CSS Menus</a></li>
	<li><a href="#">Vertical CSS Menus</a></li>
	<li><a href="#">Image CSS</a></li>
