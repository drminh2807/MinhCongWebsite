...
<br />
	...
	<ul id="menu">
    <?php
    $menungang = mysql_query("SELECT * FROM  menungang ");	
	while($row_menungang = mysql_fetch_array($menungang))
	{ 
	?>
		<li><a href="<?php echo $row_menungang['url'];  ?>" ><?php echo $row_menungang['tenmenu'];  ?></a></li>
